...
public class ArabNewsFragment extends android.support.v4.app.Fragment implements ChannelListAdapter.CustomItemClickListener{
    private static final String TAG = "ArabNewsFragment";
    ...
    public void getMusicChannels() {
        FindArabNewsChannels findArabNewsChannels = new FindArabNewsChannels();
        findArabNewsChannels.execute();
...
//        startActivity(intent, options.toBundle());
    ...
    private class FindArabNewsChannels extends AsyncTask<Void, Void, ArrayList<Channel>> {
            ...
            mDatabaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (int i = 0; i < totalChannels; i++) {
                        if (!channels.get(i).getRegion().equals("News")) {
                            channels.remove(i);
                            totalChannels--;
                            i--;
                        }
