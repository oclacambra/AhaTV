...
public class MiddleEastFragment extends android.support.v4.app.Fragment implements ChannelListAdapter.CustomItemClickListener {
    private static final String TAG = "MiddleEastFragment";
    ...
    public void getMusicChannels() {
        FindMusicChannels findMusicChannels = new FindMusicChannels();
        findMusicChannels.execute();
...
//        startActivity(intent, options.toBundle());
    ...
    private class FindMusicChannels extends AsyncTask<Void, Void, ArrayList<Channel>> {
            ...
            mDatabaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (int i = 0; i < totalChannels; i++) {
                        if (!channels.get(i).getRegion().equals("Middle East")) {
                            channels.remove(i);
                            totalChannels--;
                            i--;
                        }
    ...
    private void initRecyclerView() {
        ...
        int mNoOfColumns = ColumnUtils.calculateNoOfColumns(getContext());
